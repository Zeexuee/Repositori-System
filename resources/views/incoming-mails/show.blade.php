    ...
    <div class="mt-6 space-y-6">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-5 md:p-6 shadow-2xs space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="p-3.5 bg-slate-50/80 rounded-xl border border-slate-200/80 space-y-1" x-data="{ open: false, selectedStatus: '{{ $incomingMail->status }}' }">
                    ...
                    @can('update', $incomingMail)
                        <div class="relative inline-block text-left pt-0.5">
                            ...
                            <div x-show="open"
                                ...
                                class="absolute left-0 mt-1.5 w-48 rounded-xl bg-white shadow-xl border border-slate-200 py-1 z-30 focus:outline-hidden">
