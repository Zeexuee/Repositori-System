...
@section('content')
    ...
    @if ($activeMonthData)
        ...
        <div class="mb-8 p-4 sm:p-6 glass-card border border-slate-200/80 rounded-2xl space-y-6">
            ...
            <form method="GET" action="{{ route('repository.index') }}" class="bg-white/90 p-4 sm:p-5 rounded-2xl border border-slate-200/80 shadow-2xs space-y-4">
                ...
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    ...
                    @if (request()->hasAny(['search', 'sender', 'recipient']))
                        <a href="{{ route('repository.index', ['month' => $selectedMonth]) }}" class="text-xs font-semibold text-rose-600 hover:text-rose-800 underline">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama dokumen, subjek, no..." 
                    ...
                    <div>
                        ...
                        <input type="text" name="sender" value="{{ request('sender') }}" placeholder="Ketik pengirim" list="senders_list"
                    ...
                    <div>
                        ...
                        <input type="text" name="recipient" value="{{ request('recipient') }}" placeholder="Ketik penerima" list="recipients_list"
                               class="w-full px-3 py-2 bg-slate-50/60 border border-slate-200 rounded-xl text-xs text-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900 shadow-2xs">
    ...
    @else
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            @foreach ($monthsData as $key => $month)
                <div class="glass-card rounded-2xl p-5 sm:p-6 border border-white/90 hover:border-slate-300 transition-all duration-300 shadow-md hover:shadow-xl group relative">
