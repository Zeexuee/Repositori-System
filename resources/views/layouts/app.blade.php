            ...
            <div class="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <div class="flex items-center space-x-3">
                        <div class="w-9 h-9 bg-blue-900 rounded flex items-center justify-center text-white font-bold text-lg">
                            CS
                        </div>
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <div class="flex items-center space-x-3 text-sm">
                            ...
                            <span class="px-2.5 py-0.5 rounded text-xs font-semibold bg-blue-100 text-blue-800 border border-blue-200">
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6 bg-gray-50">
                <div class="max-w-7xl mx-auto space-y-6">
                    @if (session('success'))
                        <div class="p-4 bg-emerald-50 border border-emerald-200 text-emerald-900 rounded-md text-sm font-medium">
                            {{ session('success') }}
                        </div>
                    @endif
