                    ...
                    @auth
                        <div class="relative" x-data="{ open: false }" @click.away="open = false">
                            ...
                            <div x-show="open" 
                                ...
                                <a href="{{ route('profile.show') }}" class="w-full text-left px-3 py-2 text-xs font-bold text-slate-700 hover:bg-slate-50 border-b border-slate-100 flex items-center space-x-2 transition-all">
